...
// Do this as the first thing so that any one  reading it knows the right env.
process.env.BABEL_ENV = 'development'
process.env.NODE_ENV = 'development'
process.env.REACT_APP_SERVER_ENV = 'local'
...
if (process.env.REACT_APP_ENABLE_MOCK) {
  process.env.REACT_APP_BASE_API_URL = '/mock'
}
